...
public class ChatBot extends JFrame implements KeyListener{
	...
	String[][] chatBot={
		...
		{"what is star wars"},
		{"It is a really popular science fiction film series"},

		{"when did star wars first release"},
		{"It was first released on may 25 1977"},

		{"who created star wars"},
		{"George lucas"},

		{"what company owns star wars"},
		{"Disney"},

		//Character responses
		{"anakin"},
		{"I don't really like Anakin, he killed his love, who else do you know?"},
		{"obi-wan","obi-wan kenobi", "kenobi"},
		{"Obi-wan is very mature, who else do you know?"},
		{"jarjar", "jarjar binks", "binks"},
		{"JarJar Binks is very funny, who else do you know?"},
		{"darth vader", "vader"},
		{"Did you know darth vader is Luke's dad, who else do you know?"},
		{"padme"},
		{"padme is anakin's lover, who else do you know?"},
		{"darth maul"},
		{"Obi-wan killed darth maul, who else do you know?"},
		{"Palpatine"},
		{"Palpatine was the true sith, who else do you know?"},
		{"yoda"},
		{"Yoda trained Luke, who else do you know?"},
		{"kylo ren"},
		{"Kylo Ren is Han Solo's son, who else do you know?"},
		{"rey"},
		{"Rey is the last current jedi, who else do you know?"},
		{"chewbacca"},
		{"Chewbacca is Han Solo's best friend, who else do you know?"},
		{"han solo"},
		{"Han Solo loves Leia, who else do you know?"},
		{"boba fett"},
		{"Boba Fett was cloned to create the clone army, who else do you know"},
		{"count dooku"},
		{"Count Dooku cut off Anakin's arm, who else do you know?"},
		{"mace windu"},
		{"Mace Windu is one of the strongest jedi, who else do you know?"},
		{"admiral ackbar"},
		{"Admiral Ackbar was involved in the battle to destroy the first death star, who else do you know?"},
		{"luke"},
		{"Luke was the jedi who overthrew Palpatine, who else do you know?"},
		{"leia"},
		{"Leia is Luke's sister, who else do you know?"},
		{"lando calrissian"},
		{"Lando was a pilot who helped the Resistance, who else do you know?"},
		{"finn"},
		{"Finn was a first order trooper, who else do you know?"},
		{"po"},
		{"Po is a Resistance pilot who flies an x-wing, who else do you know"},
